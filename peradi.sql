...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2019 at 03:32 AM
...
--
-- Table structure for table `tbl_advokat`
--

CREATE TABLE `tbl_advokat` (
...
(9, '12354', 'I Made Komang SH,MH', 'L', 'Palangka Raya', '25 Agustus 1975', 'Perdata', 'beab4917ca0a231009a5c8e5c87a1154.png', '2018-11-01 15:30:08');
...
(5, 'Hasil sidang ', 'Terduga ', '2018-11-01 16:33:27', 'Ade Chandra Saputra');
...
--
-- Indexes for table `tbl_advokat`
--
ALTER TABLE `tbl_advokat`
  ADD PRIMARY KEY (`advokat_id`);
...
--
-- AUTO_INCREMENT for table `tbl_advokat`
--
ALTER TABLE `tbl_advokat`
  MODIFY `advokat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
