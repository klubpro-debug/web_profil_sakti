...
<title><?php echo SITE_NAME ." | ". ucfirst($this->uri->segment(1)) ." - Data ". ucfirst($this->uri->segment(2)) ?>
</title>
...
<link rel="stylesheet"
     href="<?php echo base_url().'resources/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css'?>">
<!-- iCheck -->
...
<!-- overlayScrollbars -->
<link rel="stylesheet"
     href="<?php echo base_url().'resources/plugins/overlayScrollbars/css/OverlayScrollbars.min.css'?>">
<!-- Daterange picker -->
