	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container-wrap">
			<div class="top-menu">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="v_beranda.html">Neat</a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="active"><a href="v_beranda.html">Home</a></li>
							<li><a href="v_galeri.html">Work</a></li>
							<li class="has-dropdown">
								<a href="v_berita.html">Blog</a>
								<ul class="dropdown">
									<li><a href="v_berita">Web Design</a></li>
									<li><a href="v_berita">eCommerce</a></li>
									<li><a href="v_berita">Branding</a></li>
									<li><a href="v_berita">API</a></li>
								</ul>
							</li>
							<li><a href="v_klub.html">About</a></li>
							<li><a href="v_kontak.html">Contact</a></li>
						</ul>
					</div>
				</div>
		...
		<div id="fh5co-services">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img src="https://cdn2.tstatic.net/tribunnews/foto/bank/images/tes-kepribadian-kupu-kupu.jpg" width="250px" height="250px">
						<div class="desc">
							<h3>Berita</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
							<footer><a class="btn btn-primary btn-learn" href="#">Read More &raquo;</a></footer>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
