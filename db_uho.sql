...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2020 at 02:41 PM
...
CREATE TABLE `artikel` (
  ...
  `artikel_kategori_nama` varchar(30) DEFAULT NULL,
  `artikel_views` int(11) DEFAULT 0,
  `artikel_gambar` varchar(40) DEFAULT NULL,
  `artikel_pengguna_id` int(11) DEFAULT NULL,
  `artikel_author` varchar(40) DEFAULT NULL,
  `artikel_img_slider` int(2) NOT NULL DEFAULT 0,
  `artikel_slug` varchar(300) NOT NULL
...
INSERT INTO `artikel` (`artikel_id`, `artikel_judul`, `artikel_isi`, `artikel_tanggal`, `artikel_kategori_id`, `artikel_kategori_nama`, `artikel_views`, `artikel_gambar`, `artikel_pengguna_id`, `artikel_author`, `artikel_img_slider`, `artikel_slug`) VALUES
(29, 'Lorem Ipsum', '<p>saaaaaaaaaasaaaaaaaaaaaaaaaaaaaaasssssssss</p>', '2020-05-23 05:06:26', 1, 'Artikel', 0, '51ca5ddc7f76db6ac9d9b6af6de6f494.jpg', 9, 'Admin', 0, 'lorem-ipsum'),
(30, 'Why do youzzs', '<p>sadasd</p>', '2020-05-23 05:13:16', 2, 'Event', 0, '2300519cbb4562247fd4fe9512214196.png', 9, 'Admin', 0, 'why-do-youzzs'),
(31, 'What is Lorem Ipsum', '', '2020-05-23 05:13:34', 3, 'Pengumuman', 0, '1fb8d9718daebf645093d3e2293e25fb.jpg', 9, 'Admin', 0, 'what-is-lorem-ipsum'),
(32, 'Test lagi', '', '2020-05-23 12:36:26', 1, 'Artikel', 0, '204b5b9b31afc48703a1bf3ea89feaaa.png', 9, 'Admin', 0, 'test-lagi');
...
CREATE TABLE `banner` (
  ...
  `banner_nama` varchar(50) DEFAULT NULL,
  `banner_tanggal` timestamp NULL DEFAULT current_timestamp(),
  `banner_pengguna_id` int(11) DEFAULT NULL,
  `banner_author` varchar(60) DEFAULT NULL,
  `banner_count` int(11) DEFAULT 0,
  `banner_cover` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `banner` (`banner_id`, `banner_nama`, `banner_tanggal`, `banner_pengguna_id`, `banner_author`, `banner_count`, `banner_cover`) VALUES
(5, 'Halo', '2020-05-23 05:10:20', 9, 'Admin', 0, '3dc9f41c8a1bddd4d944d0bcfb964776.png');
...
(1, 'Artikel', '2020-05-20 22:20:36'),
(2, 'Event', '2020-05-23 04:15:08'),
(3, 'Pengumuman', '2020-05-23 04:15:43');
...
(9, 'Admin', '', 'L', 'admin', '541ce7de15a7d7cd0e5e8161165254af', '', '', '', '', '', '', '', 1, '1', '0000-00-00 00:00:00', 'user2-160x160.jpg');
...
(946, '2020-05-17 06:19:40', '::1', 'Chrome'),
(947, '2020-05-17 17:00:53', '::1', 'Chrome'),
(948, '2020-05-20 17:01:11', '::1', 'Chrome');
...
ALTER TABLE `artikel`
  ...
  ADD KEY `tulisan_kategori_id` (`artikel_kategori_id`),
  ADD KEY `tulisan_pengguna_id` (`artikel_pengguna_id`);
...
ALTER TABLE `banner`
  ...
  ADD KEY `album_pengguna_id` (`banner_pengguna_id`);
...
--
ALTER TABLE `artikel`
  MODIFY `artikel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
